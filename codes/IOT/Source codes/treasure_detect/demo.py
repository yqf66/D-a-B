...
#results = model.predict(img_path,save=True,classes=[0,1,2],conf=0.5) # i.e. classes=0,classes=[0,3,4]

#save detection results *
results = model.predict(img_path,save=True,save_txt=True,classes=[0,1,2],conf=0.5)
